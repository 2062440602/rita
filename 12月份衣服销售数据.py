...
print("总金额为：￥", (469*65.8 + 120*49.3 + 292*96.8 + 517*86.3 + 207*135.9 + 239*253.6))
print("平均日销售量：",format(1844/30, '.1f'),"件/日")
print("羽绒服本月销售占比：",format((60610.4/198400.6*100),'.1f'),"%")
print("牛仔裤本月销售占比：",format((44617.1/198400.6*100),'.1f'),"%")
print("风衣本月销售占比：",format((28265.6/198400.6*100),'.1f'),"%")
print("皮草本月销售占比：",format((28131.3/198400.6*100),'.1f'),"%")
print("T恤本月销售占比：",format((30860.2/198400.6*100),'.1f'),"%")
print("衬衫本月销售占比：",format((5916/198400.6*100),'.1f'),"%")
